...
\end{itemize}
\item U_nᵢ
U_nᵢ(x_1\dots x_n) = (x_1 = x_1) \& (x₂ = x₂) \& \dots  \& (x_n₊_1 = xᵢ)
\begin{itemize}
...
Для конкретных a, b обявляем a = b - \top, тогда выводим
из него конъюнкцию и навешиваем два квантора
\end{itemize}
\end{enumerate}
\subsection{Теорема о представимости S}
\label{sec-11-5}
Eсли f и g_1\dots g_n представимы, то S<f, g_1\dots g_n> представима
Пусть F, G_1\dots G_n представляют их.
S(a_1\dots aₘ, b) = \exists b_1\dots \exists b_n(G_1(a_1\dots a_n, b_1) \& \dots  \& Gn(a_1\dots aₘ, b_n)
\& F(b_1\dots b_n, b))
\begin{itemize}
...
r(x_1\dots x_n, k, a) =
   \exists b\exists c(
        \exists k(β(b, c, 0, k) \& \phi(x_1\dots x_n, k))
        \& B(b, c, x_n₊_1, a)
...
Μ<F>(x_1\dots x_n₊_1) = F(x_1\dots x_n, x_n₊_1, 0) \& \forall y((y < x_n₊_1) \to \lnot F(x_1\dots x_n, y, 0))
\begin{itemize}
\item μ<f>(x_1\dots x_n) = x_n₊_1, тогда x_n₊_1 - минимальное k, такое что f(x_1..x_n,k) = 0
то есть имеем
F(x_1\dots x_n, x_n₊_1, 0)
