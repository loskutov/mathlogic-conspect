...
\def\outerline#1{\hbox to\textwidth{\hbox to0pt{\hss\hbox to 7.5pc{#1\hss}}%
\hfill}}

\def\sectionstar#1{\refstepcounter{section}%
    \markright{\thesection\hskip1em #1}%
    \vskip26pt
    \addcontentsline{toc}{section}{\protect\numberline{%
    \hbox to0pt{\hss\hbox to 2pc{A\hfill}}\thesection}#1}%
    \outerline{%
        \vbox{\hsize35.5pc
            \hrule height\hruleheight%.1pt
            \vskip 8pt
            \noindent
    \bigstar\hskip1em{\pselevenbf\thesection\hskip1em #1}}}
\vskip16pt\@afterheading}
